...
<body class="animsition">
	...
	<section class="bg0 p-b-70 p-t-5">
		<!-- Title -->
		<div  <@studio.componentAttr path=currentArticle.storeUrl ice=true /> class="bg-img1 size-a-18 how-overlay1" style="background-image: url(${currentArticle.featuredImage!""});">
			...
			<div class="row justify-content-center">
				<div class="col-md-10 col-lg-8 p-b-100">
					<div class="p-r-10 p-r-0-sr991">
						<!-- Blog Detail -->
						<div class="p-b-70">
							${currentArticle.articleBody!"CCCC"}
